...
class ThumbnailService
{
	...
	// Tọa đọ X. Cho trường hợp crop ảnh
	private $xCoordinate;

	// Tọa độ Y. Cho trường hợp crop ảnh
	private $yCoordinate;

	// Vị trí sẽ dùng cho cả 2 trường hợp crop và resize
	private $fitPosition;
	...
	public function __construct()
	{
		...
		// Hỗ trựo 2 image extension của PHP là Imagik và GD
		// ở đây dùng GD
	...
	*/
	...
	/**
	* @param double tỷ lệ sẽ resize
	* @return App\Services\ThumnailService
	*/
	...
	*/
	...
	{
		return [$this->thumbWidth, $this->thumHeight];
	}
     ...
     * @return App\Services\ThumbnailService
     */
	public function setCorrdinates($xCoord, $yCoord)
	{
     ...
     */
	public function getCorrdinates()
	{
	...
	public function save($type = 'fit', $quality = 80)
	{
		...
		//Lưu thành công. Trả về đường dẫn tới ảnh đã lưu
		return $destPath;
